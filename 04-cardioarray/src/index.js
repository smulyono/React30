...
console.log(inventors.reduce((prev = 0, item) => {
    return  prev + item.passed - item.year
}, 0));

// 5. Sort the inventors by years lived
console.table(inventors.sort((a, b) => {
    let a_live = a.passed - a.year,
        b_live = b.passed - b.year;
    return a_live < b_live ? 1 : (a.year > b.year) ? -1 : 0;
}));
...
console.log(data.reduce((map, item) => {
...
document.getElementById("root").innerHTML = "Hello World from 04-cardioarray";
